...
def is_mel(name, email):
    ...
    False
    >>> is_mel("Mel Melitpolski", "amanda@me.com")
    True
    >>> is_mel("Mel the tool", "mel@ubermelon.com")
    True
...
def most_and_least_common_type(treats):
    ...
    ('dessert', 'drink')
    >>> treats = [{"type":"dessert"},{"type":"dessert"},{"type":"appetizer"},{"type":"appetizer"},{"type":"drink"},{"type":"dessert"}]
    ...
    >>> most_and_least_common_type(treats)
    ('dessert', 'dessert')
    >>> treats = [{"type":"drink"},{"type":"dessert"},{"type":"dessert"},{"type":"drink"},{"type":"drink"},{"type":"dessert"}]
    >>> most_and_least_common_type(treats)
    ('drink', 'drink')
    >>> treats = []
    >>> most_and_least_common_type(treats)
